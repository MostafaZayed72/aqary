<template>
  ...
  async function fetchStockData() {
    ...
    const selectedStockItem = stocksList.value.find(stock => stock.symbol === selectedStock.value);
  ...
  function onModelValueUpdate(value) {
    ...
    console.log('Updated selectedStock value:', selectedStock.value);
    redirectToStockPage();
  }
